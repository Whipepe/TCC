    ...
    public partial class Triângulo : UserControl
    {
        ...
        private void txtLado1_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if ((lado1 + lado2 < lado3 || lado1 + lado3 < lado2) && (lado1 != null && lado2 != null && lado3 != null))
                {
        ...
        private void btnPedirLado1_Click(object sender, EventArgs e)
        {
            ...
            if (lado1 == null)
            {
                ...
                lblLado1.Visible = true;
                lblLado1.BringToFront();
                lblLado1.Text = Convert.ToString(Math.Round(Convert.ToDouble(lado1), 2));
                pnlLado1.Visible = false;
            }
            else
            {
        ...
        private void txtLado2_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                {
                    if ((lado1 + lado2 < lado3 || lado2 + lado3 < lado1) && (lado1 != null && lado2 != null && lado3 != null))
                    {
                        MessageBox.Show("estes valores não formam um triângulo");
                        lblLado2.Text = "";
                        lado2 = null;
        ...
        private void btnPedirLado2_Click(object sender, EventArgs e)
        {
            ...
            if (lado2 == null)
            {
                ...
                lblLado2.Visible = true;
                lblLado2.BringToFront();
                lblLado2.Text = Convert.ToString(Math.Round(Convert.ToDouble(lado2), 2));
                pnlLado2.Visible = false;
            }
            else
            {
        ...
        private void txtLado3_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if ((lado1 != 0 && lado2 != 0 && lado3 != 0) && (lado1 != null && lado2 != null && lado3 != null))
                {
                    if (lado1 + lado3 < lado2 || lado2 + lado3 < lado1)
                    {
                        MessageBox.Show("estes valores não formam um triângulo");
                        lblLado3.Text = "";
                        lado3 = null;
        ...
        private void btnPedirLado3_Click(object sender, EventArgs e)
        {
            ...
            if (lado3 == null)
            {
                ...
                else if (lado1 != null && lado2 != null && altura != null)
                {
                    ...
                    lblBasetri1.Text = Convert.ToString(Math.Round(Convert.ToDouble(basetri1),2));
                    lblBasetri1.BringToFront();
                    lblBasetri2.Visible = true;
                    lblBasetri2.Text = Convert.ToString(Math.Round(Convert.ToDouble(basetri2), 2));
                ...
                lblLado3.Visible = true;
                lblLado3.BringToFront();
                lblLado3.Text = Convert.ToString(Math.Round(Convert.ToDouble(lado3), 2));
                pnlLado3.Visible = false;
            }
            else
            {
        ...
        private void btnPedirAltura_Click(object sender, EventArgs e)
        {
            if (altura == null)
            {
                ...
                if (tipolado == 1)
                {
                    ...
                    {
                        //altura² + basetri1² = lado2² -> altura = lado2² - basetri1²
                        altura = Math.Sqrt(Math.Pow(Convert.ToDouble(lado2), 2) - Math.Pow(Convert.ToDouble(lado3/2), 2));
                    }
                    //Calculo da altura usando bastri 1 e 2
                    else if (lado2 != null && basetri1 != null)
                    {
                        altura = Math.Sqrt(Math.Pow(Convert.ToDouble(lado2), 2) - Math.Pow(Convert.ToDouble(basetri1), 2));
                    }
                    else if (lado2 != null && basetri2 != null)
                    {
                        altura = Math.Sqrt(Math.Pow(Convert.ToDouble(lado2), 2) - Math.Pow(Convert.ToDouble(basetri2), 2));
                    }
                    ...
                    {
                        // altura² + basetri1² = lado1² -> altura = lado1² - basetri1²
                        altura = Math.Sqrt(Math.Pow(Convert.ToDouble(lado1), 2) - Math.Pow(Convert.ToDouble(lado3/ 2), 2));
                    }
                ...
                else
                {
                    ...
                    {
                        altura = Math.Sqrt(Math.Pow(Convert.ToDouble(lado1), 2) - Math.Pow(Convert.ToDouble(basetri1), 2));
                    }
                    //Calculo da altura com o angulo1(lado esquerdo) -> usando seno 
                    else if (angulo1 != null && lado1 != null)
                    {
                ...
                if (altura != null)
                {
                    lblAltura.Visible = true;
                    lblAltura.BringToFront();
                    lblAltura.Text = Convert.ToString(Math.Round(Convert.ToDouble(altura), 2));
                    pnlAltura.Visible = false;
                }
                else
                {
        ...
        private void btnPedirAngulo1_Click(object sender, EventArgs e)
        {
            if (angulo1 == null)
            {
                ...
                if (angulo1 != null) { 
                    lblAngulo1.Visible = true;
                lblAngulo1.BringToFront();
                lblAngulo1.Text = Convert.ToString(Math.Round(Convert.ToDouble(angulo1), 2));
                pnlAngulo1.Visible = false;
                }
                else
                {
        ...
        private void txtAngulo2_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                if (altura_visivel == true)
                {
                    ...
                    {
                        lblAngulo2.Visible = false;
                        lblAngulo2_1.Visible = true;
                        lblAngulo2_1.BringToFront();
                        lblAngulo2_1.Text = Convert.ToString(angulo2 / 2);
                        lblAngulo2_2.Visible = true;
                        lblAngulo2_2.BringToFront();
                        lblAngulo2_2.Text = Convert.ToString(angulo2 / 2);
                    }
                    else if (tipolado == 2)
                    {
                        lblAngulo2.Visible = false;
                    ...
                    else if (tipolado == 3)
                    {
                        if (angulo_visivel == true)
                        {
                            ...
                            if (angulo1 != null && angulo2 != null)
                            {
                                lblAngulo2_1.Visible = true;
                                lblAngulo2_1.BringToFront();
                                lblAngulo2_1.Text = Convert.ToString(180 - angulo1 - 90);

                                lblAngulo2_2.Visible = true;
                                lblAngulo2_2.BringToFront();
                                lblAngulo2_2.Text = Convert.ToString(angulo2 - Convert.ToDouble(lblAngulo2_1.Text));
                            }
                            else if (angulo3 != null && angulo2 != null)
                            {
                                lblAngulo2_2.Visible = true;
                                lblAngulo2_2.BringToFront();
                                lblAngulo2_2.Text = Convert.ToString(180 - angulo3 - 90);

                                lblAngulo2_1.Visible = true;
                                lblAngulo2_1.BringToFront();
                                lblAngulo2_1.Text = Convert.ToString(angulo2 - Convert.ToDouble(lblAngulo2_2.Text));
                            }
                            else
                            {
                                lblAngulo2_1.Visible = false;
        ...
        private void btnPedirAngulo2_Click(object sender, EventArgs e)
        {
            if (angulo2 == null)
            {
                ...
                if (angulo2 != null)
                {
                    lblAngulo2.Visible = true;
                    lblAngulo2.BringToFront();
                    lblAngulo2.Text = Convert.ToString(Math.Round(Convert.ToDouble(angulo2), 2));
                    pnlAngulo2.Visible = false;
                }
                else
                {
        ...
        private void btnPedirAngulo3_Click(object sender, EventArgs e)
        {
            if (angulo3 == null)
            {
                ...
                if (angulo3 != null)
                {
                    lblAngulo3.Visible = true;
                    lblAngulo3.BringToFront();
                    lblAngulo3.Text = Convert.ToString(Math.Round(Convert.ToDouble(angulo3), 2));
                    pnlAngulo3.Visible = false;
                }
                else
                {
        ...
        {
            if (/*((angulo1 == angulo2 && angulo2 == angulo3 && angulo3 == angulo1) && (angulo1 != null && angulo2 != null && angulo3 != null)) || */((lado1 == lado2 && lado2 == lado3 && lado3 == lado1) && (lado1 != null && lado2 != null && lado3 != null)))
            {
                //tipo 1 é equilatero
                if (tipoangulo != 1)
                {
            ...
            else if (((lado1 == lado2) && (lado1 != null && lado2 != null))/* || ((angulo1 == angulo3) && (angulo1 != null && angulo3 != null))*/)
            {
                //tipo 2 é isósceles
                this.tipolado = 2;
        ...
        public void TipoAnguloTriangulo()
        {
            ...
            {
                if (lado1 != null && lado2 != null && lado3 != null && lado1 + lado2 < lado3 && lado2 + lado3 < lado1 && lado3 + lado1 < lado2)
            {

                    MessageBox.Show("Valor inválido para o triângulo");
                }
            else
            {
                MessageBox.Show("GAY");
            }
                if (angulo1 != null && angulo3 != null && lado1 != null && lado2 != null && ((angulo1 == angulo3 && lado1 != lado2) || (lado1 == lado2 && angulo1 != angulo3)))
                {
                    MessageBox.Show("Valor inválido para o triângulo");
                }
            else
